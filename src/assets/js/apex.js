                    ...
                    case "A":
                        t = (e = function(t, e) {
                            var i, a, s, r, n, o, l, h, c, d, g, u, f, p, x, b, m, v, y, w, k, A, S, C, L, P, T = Math.abs(e[1]),
                                ...
                                F = new SVG.Point(E, Y),
                                D = [];
                            if (0 === T || 0 === z || R.x === F.x && R.y === F.y) return [
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                return new Promise((function(s, r) {
                    ...
                    var o = new O(t.ctx),
                        l = new G(t.ctx);
                    if (null !== n && (o.xAxisLabelCorrections(n.xAxisTickWidth), l.setYAxisTextAlignments()), "back" === a.config.annotations.position && (i.annotations.drawAnnotations(), i.annotations.drawTexts()), e.elGraph instanceof Array)
